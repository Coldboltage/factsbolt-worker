...
export class JobsService {
  ...
  async factCheckLang({
    ...
    const result = await chain.call({
      ...
      Commence by dividing the provided statements into discrete points or closely related sentences, with a primary focus on extracting the empirical claims inherent in each statement. In the process of analyzing each segment, prioritize the evaluation of its empirical validity over the individual context of the speaker. Each statement should be categorized based on how well it aligns with established scientific consensus and empirical evidence, rather than solely on the speaker's personal perspective or context. The categories to be used are Verified Fact, Partially Verified, Personal Fact, Grounded Speculation, Grounded Opinion, Baseless Speculation, Baseless Opinion, Manipulative Opinion, Manipulative Speculation, Contextually Manipulated Fact, Factually Incorrect, Question, Incomplete Statement, or Manipulative Question. This categorization process must be firmly rooted in a broader understanding of the subject matter, referencing the wider community consensus, scientific studies, and factual data to determine the accuracy and validity of each claim. The goal is to transcend individual viewpoints and contextually isolated interpretations, aiming instead for a categorization that reflects objective truth and general scientific agreement. This approach ensures a more fact-focused and universally applicable analysis, providing a clear and reliable understanding of each statement within the broader spectrum of knowledge and consensus.
